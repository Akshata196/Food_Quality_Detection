...
from Object_detection_image_video_streamlite import *
...
def main():
    ...
    if app_mode == 'About App':
        ...
        st.image('C:/Users/HP/PycharmProjects/pythonProject/Food_Quality_Detection/Images12/ids-nxt-industrial-camera-artificial-intelligence-apple-detection-e4d34ebc.jpg')
        ...
        st.image('C:/Users/HP/PycharmProjects/pythonProject/Food_Quality_Detection/Images12/banner-integrations.png')
        st.header('Conclusion', divider='rainbow')
        st.write(
            "The integration of YOLOv8 in a Food Quality Monitoring System offers significant advancements in ensuring the safety and quality of stored food products. By automating the monitoring process and providing real-time insights, this system enhances efficiency, reduces costs, and mitigates risks associated with food storage operations."
        ...
        DEMO_IMAGE = "C:/Users/HP/PycharmProjects/pythonProject/Food_Quality_Detection/Images12/33.jpg"
        ...
        DEMO_VIDEO = 'C:/Users/HP/PycharmProjects/pythonProject/Food_Quality_Detection/Videos/video1.webm'
        ...
        st.markdown(" ", unsafe_allow_html=True)
        load_video(tffile.name, kpi_text, kpi2_text, kpi3_text, stframe)
