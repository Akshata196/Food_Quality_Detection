...
def main():
    ...
    if app_mode == 'About App':
        ...
        st.image('Food_Quality_Detection/Images12/ids-nxt-industrial-camera-artificial-intelligence-apple-detection-e4d34ebc.jpg')
        ...
        st.image('Food_Quality_Detection/Images12/banner-integrations.png')
